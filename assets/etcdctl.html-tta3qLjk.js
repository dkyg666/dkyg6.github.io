import{_ as d}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as l,d as n,b as t,e as s,a,o as r,r as c}from"./app-DT2w9O6A.js";const o={},v={href:"https://github.com/etcd-io/etcd/releases",target:"_blank",rel:"noopener noreferrer"};function u(m,e){const i=c("ExternalLinkIcon");return r(),l("div",null,[e[6]||(e[6]=n('<h1 id="使用-etcdctl" tabindex="-1"><a class="header-anchor" href="#使用-etcdctl"><span>使用 etcdctl</span></a></h1><p><code>etcdctl</code> 是一个命令行客户端，它能提供一些简洁的命令，供用户直接跟 <code>etcd</code> 服务打交道，而无需基于 <code>HTTP API</code> 方式。这在某些情况下将很方便，例如用户对服务进行测试或者手动修改数据库内容。我们也推荐在刚接触 <code>etcd</code> 时通过 <code>etcdctl</code> 命令来熟悉相关的操作，这些操作跟 <code>HTTP API</code> 实际上是对应的。</p>',2)),t("p",null,[e[1]||(e[1]=t("code",null,"etcd",-1)),e[2]||(e[2]=s(" 项目二进制发行包中已经包含了 ")),e[3]||(e[3]=t("code",null,"etcdctl",-1)),e[4]||(e[4]=s(" 工具，没有的话，可以从 ")),t("a",v,[e[0]||(e[0]=s("github.com/etcd-io/etcd/releases")),a(i)]),e[5]||(e[5]=s(" 下载。"))]),e[7]||(e[7]=n(`<p><code>etcdctl</code> 支持如下的命令，大体上分为数据库操作和非数据库操作两类，后面将分别进行解释。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>NAME:
