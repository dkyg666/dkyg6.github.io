import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,d as s,o as t}from"./app-DT2w9O6A.js";const d={};function r(l,e){return t(),i("div",null,e[0]||(e[0]=[s(`<h1 id="openwrt扩容overlay" tabindex="-1"><a class="header-anchor" href="#openwrt扩容overlay"><span>OpenWrt扩容overlay</span></a></h1><details><summary>【查看详情】</summary> 此教程根据E-SIR大神视频整理，侵删 overlay分区扩容教程 （此教程仅适用于E-SIR大神制作的固件 ） <p>ssh连接你的X86-openwrt路由器</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>Microsoft Windows [版本 10.0.19041.450]
