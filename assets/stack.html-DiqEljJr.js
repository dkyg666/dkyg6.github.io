import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,d as e,o as c}from"./app-DT2w9O6A.js";const o="/assets/wordpress-XmrimFC5.png",t={};function l(p,s){return c(),a("div",null,s[0]||(s[0]=[e(`<h1 id="在-swarm-集群中使用-compose-文件" tabindex="-1"><a class="header-anchor" href="#在-swarm-集群中使用-compose-文件"><span>在 Swarm 集群中使用 compose 文件</span></a></h1><p>正如之前使用 <code>docker-compose.yml</code> 来一次配置、启动多个容器，在 <code>Swarm</code> 集群中也可以使用 <code>compose</code> 文件 （<code>docker-compose.yml</code>） 来配置、启动多个服务。</p><p>上一节中，我们使用 <code>docker service create</code> 一次只能部署一个服务，使用 <code>docker-compose.yml</code> 我们可以一次启动多个关联的服务。</p><p>我们以在 <code>Swarm</code> 集群中部署 <code>WordPress</code> 为例进行说明。</p><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&quot;3&quot;</span>
